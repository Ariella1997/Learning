...
3. Replace the "n" ConcreteProduct with "m*n" ConcreteProduct(ConcreteProductA1,ConcreteProductA2,ConcreteProductB1,ConcreteProductB2,ect...), where "m" is the number of product families. Have each concreteProduct implement the correct AbstractProduct interface (AbstractProductA, AbstractProductB,... ect)
4. Replace the "n" ConcreteFactory classes with "m" ConcreteFactory classes (ConcreteFactory1,ConcreteFactory2,ect..), where "m" is the number of product families. Have each ConcreteFactory class implement the AbstractFactory class. In the inherited method, have the ConcreteFactory classes methods return the correct ConcreteProduct (ProductA1,ProductA2,ProductB1,ProductB2, ect..)
5. Conversion should be successful 

# of AbstractFactory = 1 -> 1
# of ConcreteFactory = n -> m 
# of AbstractProduct = 1 -> n 
# of ConcreteProduct = n -> n*m